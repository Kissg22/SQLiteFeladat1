...
namespace SQLiteFeladat1
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeContextMenuStrip()
        {
            ...
            newToolStripMenuItem.Click += new EventHandler(editToolStripMenuItem_Click);
        ...
        private void OpenNewContactForm()
        {
            try
            {
                ...
                newContactForm.Owner = this; // Beállítjuk a szülőt, hogy frissíteni tudjuk a DataGridView-t
